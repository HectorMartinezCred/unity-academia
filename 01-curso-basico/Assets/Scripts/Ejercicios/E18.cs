...
public class E18 : MonoBehaviour
{
	...
	*/
    ...
    int ElementoMasGrande(int[] elementos)
    {
        int elementoMasGrande = elementos[0];
        foreach (int elemento in elementos)
        {
            elementoMasGrande = (elemento > elementoMasGrande) ? elemento : elementoMasGrande;
        }
	...
	*/
    ...
    {
        return (posicionX >= 0f && posicionX <= 100f);
    }
    ...
    void Start()
    {
        ...
        Debug.Log(FueraDePantalla(x) ? "Estas dentro de la pantala." : "Estas fuera de la pantalla. Game Over!");
