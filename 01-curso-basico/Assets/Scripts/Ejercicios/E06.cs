...
public class E06 : MonoBehaviour
{
	...
	*/
    ...
    void Start()
    {
        ...
        string[] array = {"Vas a ser un buen programador de videojuegos",
        "Te va a tocar la loteria", "Tu juego va a ser un exito", "Tu juego va a ser un fracaso",
        "Vas a ser un programador de videojuegos cutres"};
        ...
        Debug.Log(array[numeroAleatorio]);
